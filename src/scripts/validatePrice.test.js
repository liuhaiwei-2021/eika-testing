...
test("#5 Should fail if text is empty", () => {
	// Arrange
	const testEmptyText = "";
	const resultData = "";
...
test("#6 Should fail if price is 0 because no product cost 0", () => {
	// Arrange (setup)
...
test("#7 Should fail if price is negative because products should cost more than 1", () => {
	// Arrange
...
test("#8 Should pass if you send a positive price", () => {
	// Arrange
